...
from app.service.common.subagents.prompt_templates import build_asset_messages, build_cc_skill_messages
from app.service.common.pipeline.stone_analysis_runtime import StoneAnalysisAgent
from app.service.common.subagents.writing_guide_support import (
...
class AssetSynthesizer:
    ...
    def _build_skill_documents_with_llm(
        ...
        *,
        ...
        from app.service.common.subagents.prompt_templates import build_memories_messages, build_personality_messages
