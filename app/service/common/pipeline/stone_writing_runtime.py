...
from app.service.common.pipeline.stone_analysis_support import estimate_word_count, render_writing_request
from app.service.common.subagents.writing_guide_support import build_writing_guide_payload_from_facets
...
def _load_stone_profiles_v3(session, project_id: str) -> list[dict[str, Any]]:
    from app.service.common.pipeline.stone_assets_runtime import STONE_V3_PROFILE_KEY, normalize_stone_profile_v3
...
def _load_v3_asset_payload(session, project_id: str, *, asset_kind: str) -> dict[str, Any]:
    from app.service.common.pipeline.stone_assets_runtime import is_valid_stone_v3_asset_payload
...
def _resolve_analysis_bundle_v3(self: WritingAgentService, session, project_id: str) -> StoneWritingAnalysisBundle:
    from app.service.common.pipeline.stone_assets_runtime import STONE_V3_PROFILE_KEY
