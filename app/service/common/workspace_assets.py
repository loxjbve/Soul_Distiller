...
from app.service.common.prompt_builders import build_asset_messages, build_cc_skill_messages
from app.service.stone.analysis_agent import StoneAnalysisAgent
from app.service.common.writing_guide import (
...
class AssetSynthesizer:
    ...
    def _build_skill_documents_with_llm(
        ...
        *,
        ...
        from app.service.common.prompt_builders import build_memories_messages, build_personality_messages
    ...
    def _render_analysis_reference_markdown(self, facet_dump: str) -> str:
        # Keep the main renderer aligned with the richer v2 format so Telegram mode
        # retains context-before/context-after evidence in generated analysis notes.
        return self._render_analysis_reference_markdown_v2(facet_dump)
